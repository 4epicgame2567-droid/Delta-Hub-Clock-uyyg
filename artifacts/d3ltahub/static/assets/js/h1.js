...
// Splash texts
const SplashT = [
  "Fast. Private. Unblocked.",
  "Access anything, anywhere",
  "Over 300 games and counting",
  "Tab cloaking built in — check Settings",
  "Use the panic key to escape fast",
  "Your data stays on your device",
  "Powered by Scramjet & Ultraviolet",
  "Browse freely with D3LTAHUB",
  "Try the About:Blank cloak in Settings",
